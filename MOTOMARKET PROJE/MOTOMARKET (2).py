...
while True:
    kullanici_adi = input("Kullanıcı Adını Giriniz (emrealiali): ")#kullanıcı adı tanımlamak
    ...
    if(kullanici_adi == eaa_username) and (sifre == eaa_password):#her ikiside doğru ise sayfayı devam ettiriyor
        print("3") 
        time.sleep(1) #time kütüphanesini genel olarak kullandığımız yer# colorama kütüphanesi ile renk veriyoruz 
        print("2") 
        time.sleep(1) 
        print("1")
